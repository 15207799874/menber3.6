...
(function (self) {	
	...
	function Body() {
		...
		this._initBody = function (body) {
			...
			} else if (support.arrayBuffer && support.blob && that.isDataView(body)) {
				this._bodyArrayBuffer = bufferClone(body.buffer)
				// IE 10-11 can't handle a DataView body.
				this._bodyInit = new Blob([this._bodyArrayBuffer])
			} else if (support.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(body) || that.isArrayBufferView(body))) {
